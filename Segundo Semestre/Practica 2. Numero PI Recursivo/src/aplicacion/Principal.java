...
public class Principal {
    public static void main(String[] args){
        System.out.println("El número PI es " +
                Matematicas.generarNumeroPiRecursivo(Integer.parseInt(args[0]))); //De esta manera se puede pasar el número de iteraciones por consola
        //Matematicas.generarNumeroPiIterativo(Integer.parseInt("5000"))); De esta manera se puede pasar el número de iteraciones directamente.
    }
}
